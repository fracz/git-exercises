...
do
	...
	[ -f /exercises/exercises/$exercise/hint.md ] && /exercises/exercises/$exercise/hint.md /var/www/website/backend/hook/hints/$exercise-hint.md || true
	[ -f /exercises/exercises/$exercise/summary.md ] && /exercises/exercises/$exercise/summary.md /var/www/website/backend/hook/hints/$exercise-summary.md || true
	[ -f /exercises/exercises/$exercise/solution.txt ] && /exercises/exercises/$exercise/solution.txt /var/www/website/backend/hook/hints/$exercise-solution.txt || true
	[ -f /exercises/exercises/$exercise/verification.php ] && /exercises/exercises/$exercise/verification.php /var/www/website/backend/hook/verifications/$( dashToCamelCase $exercise ).php || true
done
